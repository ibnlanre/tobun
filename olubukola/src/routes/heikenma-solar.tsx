        ...
        <section className="py-8">
          ...
          >
            ...
            <p>
              ...
              smart battery storage, and EV charging solutions that help
              customers reduce costs, achieve energy independence, and
              contribute to a sustainable future.
            </p>
            <p className="mt-4">
              <span className="font-semibold">My Role:</span> For this project,
              I worked on the visual design, color systems, typography, and
              layout structure to ensure the brand communicates trust,
              innovation, and sustainability. The result is a clean, modern, and
              impactful design that reflects Helkenma Solar's mission to power a
              brighter tomorrow.
            </p>
          </div>
        </section>
