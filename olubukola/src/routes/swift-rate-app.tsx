...
function SwiftRateApp() {
  ...
  const typographySizes = [
    ...
    { label: 'Typography', size: '32', fontClass: 'text-[32px] font-semibold' },
    { label: 'Typography', size: '24', fontClass: 'text-2xl font-medium' },
    { label: 'Typography', size: '20', fontClass: 'text-xl font-medium' },
    { label: 'Typography', size: '16', fontClass: 'text-base font-normal' },
  ]
      ...
      <main className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <section className="py-16">
          <div className="flex flex-col gap-[100px]">
            ...
            <div>
              <img
                src="/swift-rate-color-palette.svg"
                alt="Color Palette"
            ...
            <div>
              <img
                src="/swift-rate-typography-grid.png"
                alt="Typography Grid"
