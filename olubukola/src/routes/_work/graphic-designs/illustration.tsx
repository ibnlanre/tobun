...
export const Route = createFileRoute('/_work/graphic-designs/illustration')({
  component: Graphic,
})
      ...
      <section className="py-8 md:py-12">
        <div className="mb-6 md:mb-8">
          ...
          >
            ...
            concept to execution. My illustrations and graphic designs are more
            than visuals; they are stories brought to life through creativity
            and craft. I experiment with bold colors, expressive forms, and
            thoughtful composition to capture attention and communicate meaning.
            Whether it's a playful illustration, a sleek graphic layout, or a
            detailed artwork, each piece is designed to be both visually
