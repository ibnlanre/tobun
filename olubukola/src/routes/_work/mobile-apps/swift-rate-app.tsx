...
export const Route = createFileRoute('/_work/mobile-apps/swift-rate-app')({
    ...
    <Fragment>
      ...
      <section className="py-8 md:py-12">
        ...
        >
          ...
          international transfers simple, fast, and trustworthy. My focus was on
          creating a platform where users can track real-time rates, exchange
          currencies, and manage multiple wallets with ease. This project taught
          me how UI/UX design can shape financial trust, especially in fintech
          where clarity, security, and usability are essential. Swift Rate
          allowed me to craft a design that empowers users to manage money
      ...
      <section className="py-8 md:py-12">
        ...
        >
          ...
          <br />
          User Needs: Quick access to live rates, a smooth exchange process, and
      ...
      <section className="py-8 md:py-12">
        ...
        <p
          ...
          style={{ fontFamily: FONTS.MONTSERRAT }}
        >
          Wireframes: Outlined user journeys for rate checking, exchanging, and
          managing wallets.
          <br />
          ...
          <br />
          Prototype: Built an interactive flow that simulates real-time exchange
