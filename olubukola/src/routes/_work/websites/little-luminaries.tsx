...
export const Route = createFileRoute('/_work/websites/little-luminaries')({
    ...
    <Fragment>
      ...
      <section className="py-8">
        ...
        >
          ...
          <p>
            Little Luminaries is a global education brand that needed a redesign
            to improve user experience, visual appeal, and functionality. The
            goal was to create a modern, intuitive, and visually appealing
            platform that reflects the brand's mission: to create a safe and
            inspiring space for children, while building trust with parents.
            This project demonstrates my ability to take a concept from research
            to fully polished design, merging aesthetics with usability. It
            shows how thoughtful design choices in color, typography, and layout
            can strengthen brand identity while improving user trust and
            engagement.
          </p>
          <p className="mt-4">
